...
class InBreedingClutchDetailTableViewController: UITableViewController {
...
//            self.getdob = json!["bird"]["dob"].stringValue
    ...
    @objc func showActionSheet() {
           ...
           let actionSheet = MDCActionSheetController(title: "Pair Options",
            ...
            let actionOne = MDCActionSheetAction(title: "Edit Clutch",
                                                 image: UIImage(named: "Home"),
                                                 handler: {handler in
                                                     self.goToEditClutch()
            })
           let actionTwo = MDCActionSheetAction(title: "Delete Clutch",
                                                image: UIImage(named: "Home"),
                                                handler: {handler in
                                                    self.deleteClutch()
           })
    ...
    func goToEditClutch() {
        ...
        nextViewContro‌​ller.titleText = "Edit Clutch Info"
        nextViewContro‌​ller.firstEggDateToUpdate = eggLayingStartDate
        nextViewContro‌​ller.totalEggToUpdate = totalEggs
        nextViewContro‌​ller.totalChicksToUpdate = totalChicks
        nextViewContro‌​ller.clutchIDToUpdate = clutchId
