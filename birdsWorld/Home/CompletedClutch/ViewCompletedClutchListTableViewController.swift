//
//  ViewCompletedClutchListTableViewController.swift
//  birdsWorld
//
...
class ViewCompletedClutchListTableViewController: UITableViewController,  UISearchResultsUpdating {
...
//            navigationItem.rightBarButtonItem = doneButtonAsLeftArrow
       ...
       override func numberOfSections(in tableView: UITableView) -> Int {
        ...
        override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            let sample = storyBoard.instantiateViewController(withIdentifier: "CompletedBreedingClutchDetailTableViewController") as! CompletedBreedingClutchDetailTableViewController
        ...
        func loadApiType() {
            ...
            if titleText == "Lovebird Completed Clutch" {
                API.lovebirdCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
            ...
            else if titleText == "Budgerigar Completed Clutch" {
                API.budgerigarCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
                 self.birdsDetail = json!
                 for (_, value) in self.birdsDetail{
                          var value = "Male:" + value["male"]["ring_number"].stringValue + " - " + value["male"]["mutation"].stringValue + "\n" +
                                                    "Female:" + value["female"]["ring_number"].stringValue + " - " + value["female"]["mutation"].stringValue + "\n" +
             ...
             else if titleText == "Finch Completed Clutch" {
                API.finchCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
                 self.birdsDetail = json!
                 for (_, value) in self.birdsDetail{
                          var value = "Male:" + value["male"]["ring_number"].stringValue + " - " + value["male"]["mutation"].stringValue + "\n" +
                                                    "Female:" + value["female"]["ring_number"].stringValue + " - " + value["female"]["mutation"].stringValue + "\n" +
             ...
             else if titleText == "Java Completed Clutch" {
                API.javaCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
                 self.birdsDetail = json!
                 for (_, value) in self.birdsDetail{
                          var value = "Male:" + value["male"]["ring_number"].stringValue + " - " + value["male"]["mutation"].stringValue + "\n" +
                                                    "Female:" + value["female"]["ring_number"].stringValue + " - " + value["female"]["mutation"].stringValue + "\n" +
             ...
             else if titleText == "Exotic Completed Clutch" {
                API.exoticCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
                 self.birdsDetail = json!
                 for (_, value) in self.birdsDetail{
                          var value = "Male:" + value["male"]["ring_number"].stringValue + " - " + value["male"]["mutation"].stringValue + "\n" +
                                                    "Female:" + value["female"]["ring_number"].stringValue + " - " + value["female"]["mutation"].stringValue + "\n" +
             ...
             else if titleText == "Other Completed Clutch" {
                API.otherCompletedClutch(id: defaults.string(forKey: Const.UserID)!){ json, error in
                 self.birdsDetail = json!
                 for (_, value) in self.birdsDetail{
                          var value = "Male:" + value["male"]["ring_number"].stringValue + " - " + value["male"]["mutation"].stringValue + "\n" +
                                                    "Female:" + value["female"]["ring_number"].stringValue + " - " + value["female"]["mutation"].stringValue + "\n" +
