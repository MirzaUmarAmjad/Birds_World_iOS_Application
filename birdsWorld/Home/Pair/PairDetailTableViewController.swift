...
class PairDetailTableViewController: UITableViewController {
...
//            self.getdob = json!["bird"]["dob"].stringValue
    ...
    @objc func showActionSheet() {
           ...
           let actionOne = MDCActionSheetAction(title: "Add Clutch",
                                                image: UIImage(named: "Home"),
                                                handler: {handler in
                                                    self.goToAddClutch()
           })
        
            let actionTwo = MDCActionSheetAction(title: "Delete Pair",
                                                 image: UIImage(named: "Home"),
                                                 handler: {handler in
                                                     self.deletePair()
            })
    ...
    func deletePair() {
        ...
        startActivity()
        API.deletePair(id: pairId){ json, error in
            print(json)
            print(error)
